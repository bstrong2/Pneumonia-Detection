...
cnn = Conv2D(12, (8, 8), activation='relu', strides=(1, 1),
             padding='same')(input1)
cnn = Conv2D(14, (8, 8), activation='relu', strides=(1, 1),
             padding='same')(cnn)
...
mcp_save = ModelCheckpoint(fileOutput + 'Model Saves', save_best_only=True, monitor='val_acc', mode='max')
